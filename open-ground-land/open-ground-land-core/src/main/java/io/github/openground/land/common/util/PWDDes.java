...
public class PWDDes {
    ...
    private static final String KEY1 = "GROUND";

    private static final String KEY2 = "FPS";

    private static final String KEY3 = "SmartLando";
    ...
    public static void main(String[] args) {
        ...
        String str = ttt.strEnc(scin, KEY1, KEY2, KEY3);//加密
     ...
     * @return
     * @author jack.zhang
     * @data 2019年5月5日 上午9:00:12
     */
    public String strEnc(String data) {
        return this.strEnc(data, KEY1, KEY2, KEY3);
    }
    ...
    public String strEnc(String data, String firstKey, String secondKey, String thirdKey) {
        ...
        if (ObjectUtil.isNotNull(firstKey)) {
            firstKeyBt = getKeyBytes(firstKey);
            firstLength = firstKeyBt.size();
        }
        if (ObjectUtil.isNotNull(secondKey)) {
            secondKeyBt = getKeyBytes(secondKey);
            secondLength = secondKeyBt.size();
        }
        if (ObjectUtil.isNotNull(thirdKey)) {
        ...
        if (leng > 0) {
            if (leng < 4) {
                int[] bt = strToBt(data);
                int[] encByte = null;
                if (ObjectUtil.isNotNull(firstKey) && ObjectUtil.isNotNull(secondKey) && ObjectUtil.isNotNull(thirdKey)) {
                    int[] tempBt;
                    int x, y, z;
                    tempBt = bt;
                    ...
                    if (ObjectUtil.isNotNull(firstKey) && ObjectUtil.isNotNull(secondKey)) {
                        int[] tempBt;
                        int x, y;
                        tempBt = bt;
                        for (x = 0; x < firstLength; x++) {
     ...
     * @return
     * @author jack.zhang
     * @data 2019年5月5日 上午8:58:06
     */
    public String strDec(String data) {

        return this.strDec(data, KEY1, KEY2, KEY3);
    }

    /*
     * decrypt the encrypted string to the original string DES解密方法 return the
     * original string
     */
