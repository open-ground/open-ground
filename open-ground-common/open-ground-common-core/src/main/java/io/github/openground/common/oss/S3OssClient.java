...
public class S3OssClient implements OssClient {
    ...
    public PutObjectResult putObject(String keyName, File file, String bucketName) {
        return amazonS3.putObject(bucketName, keyName, file);
    }

    public PutObjectResult putObject(String keyName, File file) {
        return amazonS3.putObject("", keyName, file);
    }
